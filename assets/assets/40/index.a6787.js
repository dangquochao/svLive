  ...
  KingKongView: [ function(require, module, exports) {
    ...
    var KingKongView = function(_super) {
      ...
      function KingKongView() {
        ...
        _this.objDelayWaitShowAgWin = null;
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 4:
              if (!(this.listLineWin.length > 0 || this.isWin2Scatter || this.isScatter)) return [ 3, 7 ];
              this.infoBar.updateTotalWin(this.agWin);
              cc.tween(this.node).delay(1.5).call(function() {
                _this.setStateBtn();
                _this.effectButtonSpin();
              }).start();
             ...
             case 11:
              ...
              if (!(this.winType == WIN_TYPE.BIGWIN)) return [ 3, 15 ];
              if (!(this.isFreeSpin && this.currentFSTurn == this.totalFreeSpin)) return [ 3, 13 ];
             ...
             case 15:
              this.objDelayWaitShowAgWin = Windown_1.Windown.KingKong.getMakeDelay(this.agWin > 0 ? .5 : .25);
              return [ 4, this.objDelayWaitShowAgWin.prosime ];
