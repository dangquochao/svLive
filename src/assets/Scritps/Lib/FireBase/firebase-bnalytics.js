    ...
    try {
        ! function() {
            ...
            function se(e, t) {
                var n, r, e = oe.get(e);
                if (e) try {
                    for (var i = a(e), o = i.next(); !o.done; o = i.next())(0, o.value)(t)
                } catch (e) {
                    n = {
                        error: e
                    }
            ...
            function Ce(e) {
                return we(e, function(e) {
                    if (!Oe(e)) throw U.create("not-registered");
                    var t = e.authToken;
                    return 1 === (t = t).requestStatus && t.requestTime + B < Date.now() ? s(s({}, e), {
                        authToken: {
                            requestStatus: 0
                        }
                    }) : e
            ...
            function pt(e, t) {
                ...
                return ft || (r = ct, i = [], Array.isArray(window[r]) ? i = window[r] : window[r] = i, n = ct, r = lt, i = function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            ...
            }, "PRIVATE")), ht.registerVersion("@firebase/analytics", "0.6.14")
        }.apply(this, arguments)
    } catch (e) {
